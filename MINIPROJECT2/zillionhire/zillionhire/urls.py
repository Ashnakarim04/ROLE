...
from website.views import loginn,reg,signup, index, loggout,sample2, jobs, studentloginn, cindex, sindex, aboutuser, contactuser, cprofile, cjob, postjob, addjob,edit_job, admin_login, admin_index2,admin_profile,admin_editprofile,admin_company,addstudents,jobslist, admin_poststudent,companyprofilelist, search_company, search_student,edit_student, ad_cprofile
...
urlpatterns = [
    ...
    path('download_criteria/<int:job_id>/', views.download_criteria, name='download_criteria'),
]
if settings.DEBUG:
